...
train_proto = 'mobilenetv2_deploy.prototxt'  
train_model = 'mobilenetv2-v0.3-t3.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'mobilenetv2_mergebn_deploy.prototxt'  
save_model = 'mobilenetv2-v0.3-t3-mergebn.caffemodel'
